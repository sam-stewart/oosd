...
records=[
    ...
    Lecturer(first_name='Tom', last_name='Clark'), #5
    Lecturer(first_name='Patricia', last_name='Hayden'),#6
    Lecturer(first_name='Sam', last_name='Mann'),#7
    Lecturer(first_name='David', last_name='Rozado'),#8
    Course(id="in700002", title="Project 2", desc="Fun times", lecturer_id=7, semester=2),
    Course(id="in705001", title="Databases 3", desc="Machine learning", lecturer_id=8, semester=2),
    Course(id="in711001",title="Algorithms and Data Structures", desc="Cool things", lecturer_id=5, semester=2),
    Course(id="in700001", title="Project 1", desc="Sam Mann's holiday time", lecturer_id=7, semester=1),
    Course(id="in710001", title="OOSD", desc="Gang of four", lecturer_id=5, semester=1),
    Course(id="in719001", title="Systems Administration", desc="Puppet heaven", lecturer_id=5, semester=1),
    Course(id="in721000", title="Mobile Development", desc="Design and dev", lecturer_id=6, semester=1),
    Course(id="in712000", title="Web 3", desc="Frameworks and things", lecturer_id=6, semester = 1),
    Course(id="in715000", title="Networks 3", desc="PF, OpenBSD", lecturer_id=5, semester=2),
    Course(id="in715999", title="Virtualisation", desc="OpenStack", lecturer_id=5, semester=2),
